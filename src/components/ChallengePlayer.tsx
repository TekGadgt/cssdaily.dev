...
export default function ChallengePlayer({ challenge, allDates }: ChallengePlayerProps) {
  ...
  // TODO: Update personal link logo to something more unique when I deploy my personal site.
  return (
      ...
      <header className="border-b border-gray-700 px-4 py-3">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://github.com/TekGadgt/cssdaily.dev" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition" title="GitHub">
            ...
            <a href="https://tekgadgt.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition" title="TekGadgt">
              <img src="/prami-mono.svg" alt="TekGadgt" className="w-5 h-5 opacity-50 hover:opacity-100 transition" style={{ filter: 'invert(1)' }} />
            </a>
          </div>
        </div>
      </header>
